...
public interface ISafeCanvas {
     ...
     */
    int saveLayer(double left, double top, double right, double bottom,
     ...
     */
    int saveLayerAlpha(double left, double top, double right, double bottom,
     ...
     * canvas' clip
     */
    boolean quickReject(double left, double top, double right, double bottom,
                        EdgeType type);
     ...
     */
    void drawArc(Rect oval, float startAngle, float sweepAngle, boolean useCenter,
                 SafePaint paint);
     ...
     * @param paint May be null. The paint used to draw the bitmap
     */
    void drawBitmap(int[] colors, int offset, int stride, double x, double y,
                    int width, int height, boolean hasAlpha, SafePaint paint);

    /**
     * Legacy version of drawBitmap(int[] colors, ...) that took ints for x,y
     */
    void drawBitmap(int[] colors, int offset, int stride, int x, int y, int width,
     ...
     */
    void drawText(char[] text, int index, int count, double x, double y,
                  SafePaint paint);
     ...
     * @param paint The paint used for the text (e.g. color, size, style)
     */
    void drawText(String text, int start, int end, double x, double y,
                  SafePaint paint);
     ...
     * @param paint The paint used for the text (e.g. color, size, style)
     */
    void drawText(CharSequence text, int start, int end, double x, double y,
                  SafePaint paint);
     ...
     * @param paint The paint used for the text (e.g. color, size, style)
     */
    void drawPosText(char[] text, int index, int count, double[] pos,
                     SafePaint paint);
     ...
     * @param paint The paint used for the text (e.g. color, size, style)
     */
    void drawTextOnPath(char[] text, int index, int count, SafeTranslatedPath path,
     ...
     * @param paint The paint used for the text (e.g. color, size, style)
     */
    void drawTextOnPath(String text, SafeTranslatedPath path, float hOffset,
