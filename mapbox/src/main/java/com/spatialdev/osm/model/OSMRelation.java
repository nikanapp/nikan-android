...
public class OSMRelation extends OSMElement {
    ...
    private LinkedList<RelationMember> nodeMembers = new LinkedList<RelationMember>();
    private LinkedList<RelationMember> wayMembers = new LinkedList<RelationMember>();
    private LinkedList<RelationMember> relationMembers = new LinkedList<RelationMember>();

    private LinkedList<OSMNode> linkedNodes = new LinkedList<OSMNode>();
    private LinkedList<OSMWay> linkedWays = new LinkedList<OSMWay>();
    private LinkedList<OSMRelation> linkedRelations = new LinkedList<OSMRelation>();
