...
public abstract class OSMElement {
    ...
    private static LinkedList<OSMElement> selectedElements = new LinkedList<OSMElement>();
    private static boolean selectedElementsChanged = false;

    private static LinkedList<OSMElement> modifiedElements = new LinkedList<OSMElement>();
