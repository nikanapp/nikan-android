...
//                mCursor.commitUpdates();
    ...
    public interface IImage {
         ...
         */
        Bitmap fullSizeBitmap(int targetWidthOrHeight);

        /**
         *
         * @return an object which can be canceled while the bitmap is loading
         */
        IGetBitmap_cancelable fullSizeBitmap_cancelable(int targetWidthOrHeight);
    ...
    public interface IImageList {
        ...
        interface OnChange {
            void onChange(IImageList list);
        }

        interface ThumbCheckCallback {
            boolean checking(int current, int count);
        }

        void checkThumbnails(ThumbCheckCallback cb, int totalCount);
        ...
        void removeOnChangeListener(OnChange changeCallback);
        void setOnChangeListener(OnChange changeCallback, Handler h);
    }
