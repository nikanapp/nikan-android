...
public class ImageResizer extends ImageWorker {
	 ...
	 * @return
	 */
	public static synchronized ZoomBitmap getZoomBitmapFromFile(String filename, int reqWidth, int reqHeight) {
		...
		// Decode bitmap with inSampleSize set
		options.inJustDecodeBounds = false;
		return new ZoomBitmap(BitmapFactory.decodeFile(filename, options),options.inSampleSize);
	}
