...
public abstract class FinalActivity extends FragmentActivity {
	 ...
	 * @throws Exception
	 */
	protected static ViewInject injectField(Object injectedSource, View sourceView, Field field) throws Exception {
	...
	protected static void setViewSelectListener(Object injectedSource,Field field,String select,String noSelect)throws Exception{
	...
	protected static void setListener(Object injectedSource,Field field,String methodName,Method method)throws Exception{
		if(methodName == null || methodName.trim().length() == 0)
			return;
		
		if(ViewInject.DEFAULT.equals(methodName)) methodName = method.defaultName;
